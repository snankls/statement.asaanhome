...
<?php if(@$pdf_id){ ?>
	<a href="javascript:;" class="btn btn-dark btn-small default enable-tooltip" data-title="Print" onclick="voucher_download('<?php echo $pdf_id; ?>');">
		<span class="fa fa-edit"></span> Print
	</a>
<?php } ?>
<?php if(@$log_table){ ?>
