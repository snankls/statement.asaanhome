	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="add-form" class="form-horizontal Form" role="form" action="<?=site_url('chart_of_accounts/coa_level_1_setup_post')?>">
					...
					<div class="form-group">
						<label class="col-form-label">COA Level 1 Title <span class="error-message">*</span></label>
						<input type="text" name="coa_1" class="form-control required">
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="add-form" class="form-horizontal Form" role="form" action="<?=site_url('chart_of_accounts/coa_level_1_setup_post')?>">
					...
					<input type="hidden" name="level_1_code">
					<div class="form-group">
...
function edit_record(obj) {
	...
	$('#editModal [name="level_1_code"]').val(row_data.level_1_code);
	$('#editModal [name="coa_1"]').val(row_data.account_title);
...
$(document).ready(function() {
    initializeDataTable(site_url + "chart_of_accounts/chart_of_accounts_level_1_list");
});
</script>
