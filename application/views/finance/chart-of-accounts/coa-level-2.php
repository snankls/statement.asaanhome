                            ...
                            <table id="dt-table" class="table table-striped table-hover page_data_table">
                                <thead>
                                    <tr class="header_columns">
                                        ...
                                        <th data-data="actions" style="min-width: 100px; max-width: 100px; position: relative; text-align: center;">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="add-form" class="form-horizontal Form" role="form" action="<?=site_url('chart_of_accounts/coa_level_2_setup_post')?>">
					...
					<div class="form-group">
                        ...
                        <select name="coa_1" id="coa-1" class="form-control coa-1-dropdown required">
                            <option value="">Select One</option>
                            
                        </select>
					</div>
					<div class="form-group">
						<label class="col-form-label">COA Level 2 Title <span class="error-message">*</span></label>
						<input type="text" name="coa_2" class="form-control required">
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="add-form" class="form-horizontal Form" role="form" action="<?=site_url('chart_of_accounts/coa_level_2_setup_post')?>">
					...
					<div class="form-group">
						<label class="col-form-label">COA Level 1</label>
                        <input type="text" name="coa_level_1" class="form-control" readonly>
					</div>
					<div class="form-group">
						<label class="col-form-label">COA Level 2 Title <span class="error-message">*</span></label>
						<input type="text" name="coa_2" class="form-control required">
...
function edit_record(obj) {
    ...
    $('#editModal [name="project_id"]').val(row_data.project_id);
    $('#editModal [name="project_name"]').val(row_data.project_name);
    $('#editModal [name="coa_level_1"]').val(row_data.parent_account);
    $('#editModal [name="project_id"]').val(row_data.project_id);
    $('#editModal [name="coa_2"]').val(row_data.account_title);
...
$(document).ready(function() {
    initializeDataTable(site_url + "chart_of_accounts/chart_of_accounts_level_2_list");
});
</script>
