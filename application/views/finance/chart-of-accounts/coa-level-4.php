	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="add-form" class="form-horizontal Form" role="form" action="<?=site_url('chart_of_accounts/coa_level_4_setup_post')?>">
					...
					<div class="form-group">
                        ...
                        <select name="coa_1" class="form-control coa-1-dropdown required" id="coa-1" onchange="CF.Coa2Changed(this);">
                            <option value="">Select One</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="coa_2" class="form-control coa-2-dropdown required" id="coa-2" onchange="CF.Coa3Changed(this);">
                            <option value="">Select One</option>
                            
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">COA Level 3 <span class="error-message">*</span></label>
                        <select name="coa_3" class="form-control coa-3-dropdown required" id="coa-3">
                            <option value="">Select One</option>
                            
                        </select>
                    </div>
					<div class="form-group">
						<label class="col-form-label">COA Level 4 Title <span class="error-message">*</span></label>
						<input type="text" name="coa_4" class="form-control required">
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="add-form" class="form-horizontal Form" role="form" action="<?=site_url('chart_of_accounts/coa_level_4_setup_post')?>">
					...
					<div class="form-group">
						<label class="col-form-label">Parent Account <span class="error-message">*</span></label>
...
function submitForm(modalId) {
    ...
    // Get COA Level 3 Order if applicable
    let coa3Order = $('#coa-3 option:selected').data('order');
    if (coa3Order) {
        formData.push({ name: 'level_3_code', value: coa3Order });
    }
...
function edit_record(obj) {
    ...
    $('#editModal [name="coa_4"]').val(row_data.account_title);
...
$(document).ready(function() {
    initializeDataTable(site_url + "chart_of_accounts/chart_of_accounts_level_4_list");
});
</script>
