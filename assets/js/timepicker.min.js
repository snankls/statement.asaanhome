...
jQuery(document).ready(function(){
	jQuery(".timepicker").timepicker({defaultTIme:!1,icons:{up:"mdi mdi-chevron-up",down:"mdi mdi-chevron-down"}}),
	jQuery(".timepicker2").timepicker({showMeridian:!1,icons:{up:"mdi mdi-chevron-up",down:"mdi mdi-chevron-down"}}),
	jQuery(".timepicker3").timepicker({minuteStep:15,icons:{up:"mdi mdi-chevron-up",down:"mdi mdi-chevron-down"}})
});