      ...
      return this.each(function (i) {
        ...
        function file(file) {
          ...
          function allOkey() {
            ...
            if (!file.type.match("image.*")) {
			  ...
			  aks_file_uploaded_callback(filepreview, settings);
            } else {
              ...
              reader.onload = function (e) {
                ...
                $('[data-file="' + fileName + '"]').fadeIn(650);
			  	aks_file_uploaded_callback(preview, settings);
              };
        ...
        function fileDelete() {
          $(".aks-file-upload-delete").on("click", function () {
          	let preview_container = $(this).closest('.aks-file-upload')[0];
            ...
            dataRemove(deleteBtn);
			  aks_file_delete_callback(preview_container, settings);
          });
        }
        function ajaxUpload() {
